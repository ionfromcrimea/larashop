    ...
    $('#catalog-sidebar .badge').on('click', function () {
        ...
        if (closed) {
            $badge.siblings('ul').slideDown('normal', function () {
                $badge.children('i').removeClass('glyphicon glyphicon-plus').addClass('glyphicon glyphicon-minus');
            });
        } else {
            $badge.siblings('ul').slideUp('normal', function () {
                $badge.children('i').removeClass('glyphicon glyphicon-minus').addClass('glyphicon glyphicon-plus');
            });
        }
    });
});
